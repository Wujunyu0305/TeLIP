...
## 📌 Overview
`TeLIP` is a deep learning model designed to predict landslide initiation positions based on topographic and geologic features of hillslopes. It uses transformer-based architecture to capture the spatial dependencies among terrain pixels by using local-area samples. This model is capable of handling complex relationships between terrain features and landslide initiation position, and providing interpretable outputs for landslide susceptibility assessments.
...
## 📊 Datasets
Example dataset link: [Figshare](https://doi.org/10.6084/m9.figshare.29816060.v1)
